...
export class ActivityController {
  ...
  constructor(
    ...
    @Inject(GET_SPORTS_QUERY_HANDLER) private readonly getSportsUseCase: GetSportsQueryHandler,
    @Inject(GET_ACTIVITY_QUERY_HANDLER) private readonly getActivityUseCase: GetActivityQueryHandler,
    ...
    switch (error.id) {
      case CreateActivityCommandError.invalidUserIdId: {
        this.loggerService.error('Critical error', error.stack, {
          reason: 'User ID was validated by Access Token Guard but rejected by domain',
