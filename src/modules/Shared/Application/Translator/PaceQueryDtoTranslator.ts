...
export class PaceQueryDtoTranslator implements ApplicationDtoTranslatorInterface<PacePrimitives, MagnitudeQueryDto> {
  public translate(primitives: PacePrimitives): MagnitudeQueryDto {
