...
describe('PostgreSqlUserCredentialRepository', () => {
  ...
  describe('update', () => {
    ...
    it('should update entity correctly including password hash', async () => {
      ...
      expect(updatedRow!.last_login_at).toEqual(updatedAt)
      expect(updatedRow!.updated_at).toEqual(updatedAt)
    ...
    it('should not update entity when it is not found', async () => {
      ...
      expect(originalRow!.locked_until).toEqual(rawUserCredential.locked_until)
      expect(originalRow!.last_login_at).toEqual(rawUserCredential.last_login_at)
      expect(originalRow!.updated_at).toEqual(rawUserCredential.updated_at)
    })
  })
